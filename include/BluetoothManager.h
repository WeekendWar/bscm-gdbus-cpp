...
private:
    ...
    // Helper methods
    void handle_interfaces_added(const std::string& object_path, GVariant* interfaces);
    void handle_interfaces_removed(const std::string& object_path, const std::vector<std::string>& interfaces);
    void handle_properties_changed(const std::string& object_path, const std::string& interface_name, GVariant* changed_properties);
