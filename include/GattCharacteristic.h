...
private:
    ...
    // D-Bus callbacks
    static void on_read_ready(GObject* source_object, GAsyncResult* result, gpointer user_data);
    static void on_write_ready(GObject* source_object, GAsyncResult* result, gpointer user_data);
    static void on_start_notify_ready(GObject* source_object, GAsyncResult* result, gpointer user_data);
    static void on_stop_notify_ready(GObject* source_object, GAsyncResult* result, gpointer user_data);
...
public:
    GattCharacteristic(GDBusConnection* connection, const std::string& object_path);
    ~GattCharacteristic();
